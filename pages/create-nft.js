...
const CreateNFT = () => {
  ...
  const onDrop = useCallback(() => {
    // upload image to the blockchain or to IPFS
    // IPFS powers the distributed web, peer-to-peer hypermedia protocol designed to preserve and grow humanity's knowledge by making the web upgradeable, resilient, and more open
  }, []);
